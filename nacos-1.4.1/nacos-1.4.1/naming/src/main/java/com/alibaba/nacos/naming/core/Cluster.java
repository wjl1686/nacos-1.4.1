...
public class Cluster extends com.alibaba.nacos.api.naming.pojo.Cluster implements Cloneable {
    ...
    private static List<Instance> updatedIps(Collection<Instance> newInstance, Collection<Instance> oldInstance) {
        //取交集
    ...
    public static void main(String[] args) {
        Collection<Instance> newInstance = new ArrayList<>();
        Instance instance1 = new Instance();
        instance1.setIp("11");
        instance1.setPort(9000);
        Instance instance2 = new Instance();
        instance2.setIp("11");
        instance2.setPort(9001);
        newInstance.add(instance1);
        newInstance.add(instance2);
        Collection<Instance> oldInstance = new ArrayList<>();
        Instance instance3 = new Instance();
        instance3.setIp("22");
        instance3.setPort(9003);
        oldInstance.add(instance1);
        oldInstance.add(instance2);
        oldInstance.add(instance3);
        List<Instance> intersects = (List<Instance>) CollectionUtils.intersection(newInstance, oldInstance);
        System.out.println(JSON.toJSONString(intersects));

        updatedIps(newInstance ,oldInstance);
    }
}
